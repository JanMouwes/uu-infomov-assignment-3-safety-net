...
void Game::Init()
{
    ...
    for (int y = 0; y < 12; y++)
        ...
        {
            Actor* army1Tank = tanks_system->SpawnTank(tank1, make_int2(40 + x * 32, 2620 - y * 32), make_int2(5000, -500), 0, 0);
    ...
    for (int y = 0; y < 8; y++)
        ...
        {
            Actor* army1Tank = tanks_system->SpawnTank(tank1, make_int2(1440 + x * 32, 2220 - y * 32), make_int2(3500, -500), 0, 0);
